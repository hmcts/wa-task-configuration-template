...
class CamundaTaskWaPermissionTest extends DmnDecisionTableBaseUnitTest {
    ...
    @Test
    void given_processRequestTaskId_taskType_when_evaluate_dmn_then_it_returns_expected_rule() {
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue("taskAttributes", Map.of("taskType", "processRequestTaskId"));
